# @hoangcung1804npm/minima-sed-magni
...
[![Actions Status](https://github.com/hoangcung1804npm/minima-sed-magni/actions/workflows/run-tests.yml/badge.svg?branch=master)](https://github.com/hoangcung1804npm/minima-sed-magni/actions)
[![npm version](https://img.shields.io/npm/v/@hoangcung1804npm/minima-sed-magni.svg)](https://www.npmjs.com/package/@hoangcung1804npm/minima-sed-magni)
[![NPM License](https://img.shields.io/npm/l/@hoangcung1804npm/minima-sed-magni.svg)](https://github.com/hoangcung1804npm/minima-sed-magni/blob/master/LICENSE)
...
npm install @hoangcung1804npm/minima-sed-magni @cucumber/cucumber testcafe gherkin-testcafe --save-dev # To install dependencies and save them to package.json
node node_modules/@hoangcung1804npm/minima-sed-magni/utils/prepare.js # To create basic test and Page Object files
```
...
![Install @hoangcung1804npm/minima-sed-magni](https://raw.githubusercontent.com/Marketionist/@hoangcung1804npm/minima-sed-magni/master/media/@hoangcung1804npm/minima-sed-magni-installation.gif)
...
To install the @hoangcung1804npm/minima-sed-magni package and its peerDependencies and to
save it to your `package.json` just run:

```bash
npm install @hoangcung1804npm/minima-sed-magni @cucumber/cucumber testcafe gherkin-testcafe --save-dev # In case if you want to use Cucumber 7 (the recent one)
```
OR
```bash
npm install @hoangcung1804npm/minima-sed-magni cucumber@6.0.5 testcafe gherkin-testcafe@2.5.1 --save-dev # In case if you want to use Cucumber 6
```
OR
```bash
npm install @hoangcung1804npm/minima-sed-magni cucumber@5.1.0 testcafe gherkin-testcafe@2.5.1 --save-dev # In case if you want to use Cucumber 5
```
...
run additionally:
```bash
node node_modules/@hoangcung1804npm/minima-sed-magni/utils/prepare.js
```
...
[`test1-user.feature`](https://github.com/hoangcung1804npm/minima-sed-magni/blob/master/tests/test1-user.feature) and
[`test2-user.feature`](https://github.com/hoangcung1804npm/minima-sed-magni/blob/master/tests/test2-user.feature).
...
file like this:
```javascript
const pageObjects = require('@hoangcung1804npm/minima-sed-magni/utils/get-page-objects.js');
```
...
```bash
node_modules/.bin/gherkin-testcafe chrome,firefox node_modules/@hoangcung1804npm/minima-sed-magni/index.js tests/**/*.js tests/**/*.feature
```
...
```bash
PO_FOLDER_PATH='tests/my-custom-page-objects' node_modules/.bin/gherkin-testcafe chrome,firefox node_modules/@hoangcung1804npm/minima-sed-magni/index.js tests/**/*.js tests/**/*.feature
```
...
```json
"test-e2e": "PO_FOLDER_PATH='tests/my-custom-page-objects' node_modules/.bin/gherkin-testcafe 'chrome:headless' node_modules/@hoangcung1804npm/minima-sed-magni/index.js tests/**/*.js tests/**/*.feature"
```
...
- tags to run:
    ```bash
    node_modules/.bin/gherkin-testcafe chrome,firefox node_modules/@hoangcung1804npm/minima-sed-magni/index.js tests/**/*.js tests/**/*.feature --tags @fast
    ```

    When using more than one tag, the list needs to be comma separated:
    ```bash
    node_modules/.bin/gherkin-testcafe chrome node_modules/@hoangcung1804npm/minima-sed-magni/index.js tests/**/*.js tests/**/*.feature --tags @fast,@long
    ```
...
- custom parameter types:
    ```bash
    node_modules/.bin/gherkin-testcafe chrome node_modules/@hoangcung1804npm/minima-sed-magni/index.js tests/**/*.js tests/**/*.feature --param-type-registry-file ./a-file-that-exports-a-parameter-type-registry.js
    ```
...
{
    "browsers": "chrome",
    "src": ["node_modules/@hoangcung1804npm/minima-sed-magni/index.js", "tests/**/*.js", "tests/**/*.feature"],
    "screenshots": {
...
in [`test1-page.js`](https://github.com/hoangcung1804npm/minima-sed-magni/blob/master/tests/page-model/test1-page.js).
It can also be used in your custom Cucumber steps - for example:
```javascript
const SelectorXPath = require('@hoangcung1804npm/minima-sed-magni/utils/selector-xpath.js');
...
[CONTRIBUTING.md](https://github.com/hoangcung1804npm/minima-sed-magni/blob/master/CONTRIBUTING.md)
...
[GitHub](https://github.com/hoangcung1804npm/minima-sed-magni).
